...
def main():
    key_books = ('./books/gullivers-travels.txt', './books/shakespeare-works.txt', './books/great-gatsby.txt')
...
# process_books('./books/great-gatsby.txt', './books/tess-work.txt')
# cb = generate_code_book()
# save('./code_books/book1.json', cb)
#
# cb = load('./code_books/book1_r.json', './books/great-gatsby.txt', './books/tess-work.txt', reverse=True)
# message = input("Type your message here: ")
# print(encrypt(load('./code_books/book1.json', './books/great-gatsby.txt', './books/tess-work.txt', reverse=True), message))
#
# enc_message = "55-18-23-14-35-91-76-60-62-64-27-20-49-7-61-24-5-90-130-6-126-20-50-21-119-9-51-112-52-110-88-9-95-70-38-3-56-47-32-39-38-2-60-18-66"
#
# print(decrypt(cb, enc_message))
